...
show2d(axs[0], model1, ionid)
axs[0].set_title(ionname+", T = 1e4")
show2d(axs[1], model2, ionid)
axs[1].set_title(ionname+", T = 2e4")
fig.subplots_adjust(left=0.1, right=0.9, wspace=0.01)
