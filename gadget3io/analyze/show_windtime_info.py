...
for modeli in range(len(models)):
    fname = "/scratch/shuiyao/scidata/gadget3io/"+models[modeli]+"/"+models[modeli]+"_"+zstr+".starinfo"
    soname = "/proj/shuiyao/"+models[modeli]+"/so_z"+zstr+".sovcirc"
    foutname = "/scratch/shuiyao/scidata/gadget3io/"+models[modeli]+"/"+models[modeli]+"_"+zstr+".mprof."
    print "Doing: ", fname
