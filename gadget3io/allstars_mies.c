...
void main(int argc, char **argv)
{
  ...
  if(flag_allstars){
    ...
    sprintf(outname, "./%s/%s_%s.stars", modelname, modelname, snapstr);
    ...
    sprintf(outm11, "./%s/%s_%s.stars.mh11", modelname, modelname, snapstr);
    sprintf(outm12, "./%s/%s_%s.stars.mh12", modelname, modelname, snapstr);
    sprintf(outm13, "./%s/%s_%s.stars.mh13", modelname, modelname, snapstr);    
