...
def batch():
    ...
    for n in [snapstr]:
        ...
        print infile+" >"
        print outfile
        smf(infile, outfile, plot=False)

for snapstr in ["033", "058", "078", "108"]:    
    # snapstr = "001"
    outfile = OUTBASE+"/gsmf_"+snapstr+".txt"
    batch()
