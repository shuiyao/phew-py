...
# gridfiles = [\
#              "l25n144-phew-mach1"+"/"+"tabmet_z0_100",\
#              "l25n144-phew-fa"+"/"+"tabmet_z0_100"\             
# ]
gridfiles = [\
             "/scratch/shuiyao/scidata/metals/tabmet_01_098",\
             "/scratch/shuiyao/scidata/metals/tabmet_zw_098",\             
             "l25n144-phewoff"+"/"+"tabmet_z0_098",\
             "l25n144-phew-rcloud"+"/"+"tabmet_z0_098"\
]
lgds = ["Gadget3-DESPH","Gadget3-PESPH","GIZMO-PhEWOff","GIZMO-PhEW"]
...
#    plt.axis([xnodes[0], xnodes[-1], ynodes[0], ynodes[-1]])
    ...
    if (n_sub == 3):
        plt.ylabel(r'$Log(T)$')        
        plt.title(lgds[2], y = 1.07)
    if (n_sub == 4):
        plt.title(lgds[3], y = 1.07)
